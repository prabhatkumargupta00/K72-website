...
const FullNav = () => {
  ...
  useGSAP(function () {
    ...
    if(navOpen){
      fullScreenRef.current.style.displey = 'block',
      tl.play()
    }else{
      fullScreenRef.current.style.displey = 'none',
      tl.reverse()
    }
  ...
  return (
    <div ref={fullScreenRef} id='fullScreenNav' className="overflow-hidden text-white h-screen w-full absolute z-50">
      ...
      <div ref={fullNavLinksRef} className='relative'>
        ...
        <div className='py-16' id='all-links'>
          <div className='mainLink origin-top relative  border-t-1 border-white'>
          ...
          <div className='mainLink origin-top relative  border-y-1 border-white'>
